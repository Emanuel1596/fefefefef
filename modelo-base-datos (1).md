...
| Solicitud_Instructor | Usuario alumno que solicita ser instructor o usuario administrador que revisa |
...
En este caso, la orden 50 contiene dos cursos comprados.

#### Inscripcion

| id_inscripcion | id_orden_detalle | id_estado_inscripcion |
|---:|---:|---:|
| 80 | 1 | 1 |
| 81 | 2 | 1 |

En este caso, cada inscripción nace de un curso específico comprado dentro del detalle de la orden.
...
| En Solicitud_Instructor, id_usuario_solicitante debe pertenecer al usuario que solicita el cambio de rol | La solicitud debe estar ligada a una cuenta real |
| En Solicitud_Instructor, id_usuario_revisor debe pertenecer a un usuario con rol Administrador | Solo un administrador debe revisar solicitudes |
...
| Pago aprobado | Se crea una inscripción activa por cada Orden_Detalle |
